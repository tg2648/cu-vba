Sub Extract_dashboard_data_by_dept()
...
current_workbook_name = "Department_Profiles_Data_Dashboard.xlsx"
...
data_sheets = Array("Dept_Classes_Enrollment", "Dept_Faculty", "Dept_Programs_Undergraduate", "Dept_Programs_Graduate")
...
For Each Department In dept_list
    ...
    new_workbook_name = filepath & "\Department_Profiles_Data_" & Department & ".xlsx"
    ...
    For Each data_sheet In data_sheets
        ...
        ' Filter by department in the second column
        data_range.AutoFilter Field:=2, Criteria1:=Department
...
For Each data_sheet In data_sheets
    ...
    current_workbook.Sheets(data_sheet).ListObjects(data_sheet).Range.AutoFilter Field:=2
